...
It lets you extend Radashi while keeping your changes separated from our codebase. It also lets you import others' unmerged PRs into your Radashi. Use others' code without the risk of installing yet another NPM package.
